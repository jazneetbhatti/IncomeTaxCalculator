...
<html>
	...
	<body>
		<div id="wrapper" style="position: absolute; top: 1%">
			<div style="font-weight: bold" align="center">NATIONAL INSTITUTE OF TECHNOLOGY, DURGAPUR</div>
			<br>
			<div style="text-decoration: underline" align="center">DETAIL OF SALARY DRAWN AND OTHER INCOME FOR THE FINANCIAL YEAR <?php echo $_SESSION['financial-year']."-".( $_SESSION['financial-year'] + 1 );?>(ASSESSMENT YEAR <?php echo $_SESSION['financial-year']."-".( $_SESSION['financial-year'] + 1 );?>)</div>
			<br>
			<?php
				...
				echo "<tr><td><div style=\"font-weight: bold\">Financial Year : </div></td><td>".$row['year']."-".($row['year'] + 1)."</td></tr>";
				echo "</tbody>";
				echo "</table>";
				echo "</div>";
			?>
			...
			<div>Verified from Bill Register</div>
			<br><br>
			<div style="float: left; font-weight: bold; font-style: italic; text-decoration: underline; position: relative; left: 0">Dealing Assistant</div>
			<div style="float: left; font-weight: bold; font-style: italic; text-decoration: underline; position: relative; left: 25%">Head Assistant</div>
			<div style="float: left; font-weight: bold; font-style: italic; text-decoration: underline; position: relative; left: 50%">Signature of Assessee with date</div>
		</div>
